...
const OPERATIONS = {
  ...
  INVEST_CLERK: [
    ...
    },
    {
      ...
      fields: [
        { n: 'force', label: '立即确认全部待处理（演示，忽略T+1日期）', type: 'checkbox', hint: '不勾=真实模式：只确认「确认日/到账日已到（≤今天）」的；当天申购确认日是明天，当天点是0笔。勾上=演示用，无视日期把全部待处理直接确认' },
      ],
      hint: '真实 T+1：今天申购、确认日是明天，到明天点这里才会确认（这是正确行为）。要现场演示状态流转，就勾「立即确认全部待处理」。',
